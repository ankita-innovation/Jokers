...
//        self.titleMessage = title
        self.titleMessage = EMPTY_STRING
    ...
    private func setupUI() {
        ...
        messageLabel.font = UIFont.init(name: APP_FONT_REGULAR, size: 15)
        titleLabel.font = UIFont.init(name: APP_FONT_REGULAR, size: 17)
    ...
    private func setupButton() {
        ...
        self.posButton.setTitleColor(PRIMARY_COLOR, for: .normal)
        self.posButton.titleLabel?.font = UIFont.init(name: APP_FONT_REGULAR, size: 15)
        self.negButton.titleLabel?.font = UIFont.init(name: APP_FONT_REGULAR, size: 15)
