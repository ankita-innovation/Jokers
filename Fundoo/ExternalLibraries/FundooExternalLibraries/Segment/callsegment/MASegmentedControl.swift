...
public class MASegmentedControl: UIControl {
    ...
    static let imageInsets: UIEdgeInsets = UIEdgeInsets.init(top: 10, left: 20, bottom: 10, right: 0)
    static let bottomLineThumbViewHeight: CGFloat = 5.0
    
    var didsegmentSelected: ((_ index:Int) -> Void)?
    ...
    @IBInspectable public var customBorderWidth: CGFloat = 0 {
        didSet {
            ...
            thumbView.layer.borderWidth = customBorderWidth
        }
    }
    ...
    @IBInspectable public var customBorderColor: UIColor = .clear {
        didSet {
            ...
            thumbView.layer.borderColor = customBorderColor.cgColor
...
//            btn.backgroundColor = .red
    ...
    private func setThumbView() {
        ...
        thumbView.frame = CGRect(x: thumbViewPositionX, y: thumbViewPositionY, width: thumbViewWidth+20, height: thumbViewHeight)
