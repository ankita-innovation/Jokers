...
open class TTSegmentedControl: UIView {
    ...
    open override func layoutSubviews() {
        ...
        containerView.border(color: TEXT_SECONDARY_COLOR)
...
extension TTSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrame() {
        ...
        thumbView.frame.size.height = containerView.frame.size.height - 2
        thumbView.layer.cornerRadius = cornerRadius < 0 ? 0.5 * thumbView.frame.size.height : cornerRadius
        thumbView.frame.origin.y = 1
        
        thumbView.frame.origin.x = -1
        thumbView.frame.size.width = thumbView.frame.size.width+1
