...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    open override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        let distanceFromLeftHandle: CGFloat = touchLocation.distance(to: leftHandle.frame.centerr)
        let distanceFromRightHandle: CGFloat = touchLocation.distance(to: rightHandle.frame.centerr)
    ...
    private func updateColors() {
        ...
        if let initialColor = initialColor?.cgColor, isInitial {
            ...
            let tintCGColor: CGColor = UIColor.lightGray.cgColor
