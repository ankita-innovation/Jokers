...
extension SVCSwipeViewController {
    ...
    func addSwitchContent() {
        ...
        if #available(iOS 11.0, *) {
            cnstrBottomSwipeContent = view.bottomAnchor.constraint(equalTo: swipeContent.bottomAnchor,
    ...
    func updateSwitchContentTopAnchor() {
        ...
        if #available(iOS 11.0, *) {
            cnstrTopSwipeContent = swipeContent.topAnchor.constraint(equalTo: view.topAnchor,
    ...
    func addTabBar() {
        ...
        var height = CGFloat()
        print("height for iphonex \(UIScreen.main.nativeBounds.height)")
