...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BBMetalImage/BBMetalImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Cache/Cache.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CryptoSwift/CryptoSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DialCountries/DialCountries.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MediaWatermark/MediaWatermark.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RangeControl/RangeControl.framework"
  ...
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/ffmpegkit.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavcodec.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavdevice.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavfilter.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavformat.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavutil.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libswresample.framework"
  install_framework "${PODS_ROOT}/ffmpeg-kit-ios-full/libswscale.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iRecordView/iRecordView.framework"
